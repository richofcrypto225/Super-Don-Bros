      ...
      <section className="relative z-30 min-h-screen flex flex-col items-center justify-center px-4 pt-20 pb-32">
        ...
        >
          <div className="logo-container relative mx-auto mb-8 w-full max-w-2xl">
            ...
            <motion.div initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.7, delay: 0.2 }} className="relative">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white drop-shadow-[0_0_5px_rgba(255,255,255,0.8)]">Be the Main Character</h2>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-cyan-300 drop-shadow-[0_0_5px_rgba(0,255,255,0.5)]">No presale. No dev wallet. No VC. 1 billion coins. All in your hands.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={scrollToDex} className="bg-yellow-400 hover:bg-yellow-300 text-black text-xl px-8 py-6 rounded-xl font-bold transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,0,0.6)] animate-bounce-slow">
              Get $DONBROS Now <ArrowDown className="ml-2 h-5 w-5" />
            </Button>
            <Button onClick={scrollToVideos} className="bg-blue-600 hover:bg-blue-500 text-white text-xl px-8 py-6 rounded-xl font-bold transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(0,100,255,0.6)]">
              Watch Gameplay
            </Button>
          </div>
        </motion.div>
